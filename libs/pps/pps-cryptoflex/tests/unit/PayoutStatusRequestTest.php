...
use pps\cryptoflex\CryptoFlexApi\Requests\crypto\CryptoPayoutStatusRequest;

class PayoutStatusRequestTest extends Unit
{
    /**
    ...
    */
    ...
    {
        /**
         * @var CryptoPayoutStatusRequest $payout
        */
        $payout = \pps\cryptoflex\CryptoFlexApi\Requests\BaseRequest::getRequest($this->config, [
            ...
            'crypto_currency' => 'BTC',
            'partner_withdraw_id' => 'cryptoflex_',
        ]);
        $this->assertInstanceOf(CryptoPayoutStatusRequest::class, $payout);
        ...
        $this->assertAttributeEquals('cryptoflex_', 'partner_withdraw_id', $payout);
