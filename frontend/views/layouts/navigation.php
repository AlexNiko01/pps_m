<div id="navigation" class="list-group">
    ...
    <div id="navigation-77" class="submenu panel-collapse collapse">
        ...
        <a class="get-content list-group-item" href="/docs_dist/common-components-exception-settingsexception.html">SettingsException</a>
    ...
    <div id="navigation-78" class="submenu panel-collapse collapse">
        ...
        <a class="get-content list-group-item" href="/docs_dist/common-components-helpers-logger.html">Logger</a>
        <!--        --><? //= Html::a('Restructuring', ['/site/common-components-helpers-restructuring'], ['class' => 'list-group-item']) ?>
        <a class="get-content list-group-item" href="/docs_dist/common-components-helpers-restructuring.html">Restructuring</a>
    ...
    <div id="navigation-79" class="submenu panel-collapse collapse">
        ...
        <a class="get-content list-group-item" href="/docs_dist/common-components-inquirer-paymentsysteminquirer.html">PaymentSystemInquirer</a>
    ...
    <div id="navigation-80" class="submenu panel-collapse collapse">
        ...
        <a class="get-content list-group-item" href="/docs_dist/common-components-sender-messagesender.html">MessageSender</a>
        <!--        --><? //= Html::a('RocketChatSender', ['/site/common-components-sender-rocketchatsender'], ['class' => 'list-group-item']) ?>
        <a class="get-content list-group-item" href="/docs_dist/common-components-sender-rocketchatsender.html">RocketChatSender</a>
        <!--        --><? //= Html::a('Sender', ['/site/common-components-sender-sender'], ['class' => 'list-group-item']) ?>
        <a class="get-content list-group-item" href="/docs_dist/common-components-sender-sender.html">Sender</a>
        <!--        --><? //= Html::a('TelegramSender', ['/site/common-components-sender-telegramsender'], ['class' => 'list-group-item']) ?>
        <a class="get-content list-group-item" href="/docs_dist/common-components-sender-telegramsender.html">TelegramSender</a>
    ...
    <div id="navigation-81" class="submenu panel-collapse collapse">
        ...
        <a class="get-content list-group-item"
           href="/docs_dist/console-controllers-croncontroller.html">CronController</a>

        <!--        --><? //= Html::a('NotificationController', ['/site/console-controllers-notificationcontroller'], ['class' => 'list-group-item']) ?>
        <a class="get-content list-group-item" href="/docs_dist/console-controllers-notificationcontroller.html">NotificationController</a>
